  ...
  function render(mode, el, holder, src) {
    ...
    if (mode == "image") {
      ...
      if (instance_config.use_fallback) {
        ...
        el.setAttribute(
          "src",
          draw({ ctx: ctx, dimensions: dimensions, template: theme, ratio: ratio, holder: holder })
        );
      ...
      e.atob ||
        (e.atob = function (e) {
          ...
          for (
            var o, n, a = 0, i = 0, c = "";
            (n = e.charAt(i++));
            ~n && ((o = a % 4 ? 64 * o + n : n), a++ % 4) ? (c += String.fromCharCode(255 & (o >> (6 & (-2 * a))))) : 0
          )
            n = r.indexOf(n);
          return c;
        });

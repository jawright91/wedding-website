...
!(function (a, b) {
  ...
  var y,
    ...
    B = (n.fn.init = function (a, b) {
      ...
      if ("string" == typeof a) {
        if (
          ((c = "<" === a.charAt(0) && ">" === a.charAt(a.length - 1) && a.length >= 3 ? [null, a, null] : A.exec(a)),
          !c || (!c[1] && b))
        )
          ...
          if (1 === i.nodeType && (i.disabled !== !0 || "click" !== a.type)) {
            for (e = [], f = 0; h > f; f++)
              (d = b[f]),
                (c = d.selector + " "),
                void 0 === e[c] &&
                  (e[c] = d.needsContext ? n(c, this).index(i) >= 0 : n.find(c, this, null, [i]).length),
                e[c] && e.push(d);
    ...
    addClass: function (a) {
      ...
      if (j)
        for (b = (a || "").match(F) || []; i > h; h++)
          if (
            ((c = this[h]), (d = 1 === c.nodeType && (c.className ? (" " + c.className + " ").replace(vc, " ") : " ")))
          ) {
            f = 0;
    ...
    ajax: function (a, b) {
      ...
      (h = k.global),
        ...
        k.hasContent ||
          ...
          k.cache === !1 &&
            (k.url = Cc.test(e) ? e.replace(Cc, "$1_=" + wc++) : e + (xc.test(e) ? "&" : "?") + "_=" + wc++)),
        k.ifModified &&
